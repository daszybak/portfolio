      ...
      <div className="app__about" ref={aboutRef}>
        ...
        <div className="app__flex-image-text">
          <p className="p-text">
            ...
            for a laboratory tool. <br /> <br /> The laboratory tool is now the
            foundation for future Ph.D. theses. Throughout my Master's Studies,
            I have worked on numerous projects where close collaboration and
            teamwork were crucial to completing the tasks on time. <br /> <br />
            Now, I work daily to develop my skills and increase my knowledge in
            software development. Working joyfully on my web development
